...
const verUsuario = async (body) => {
    const mensaje = await axios.get(`${URL_CONNECT_BACKEND}/api/verUsuario`,body)
    return mensaje.data
}

const eliminarUsuario = async (id) => {
    const mensaje = await axios.delete(`${URL_CONNECT_BACKEND}/api/eliminarUsuario/${id}`)
    return mensaje.data
}
