    ...
    <>
      <View style={styles.container}>
        ...
        <View style={styles.containerMapa}>
            ...
            {isVisibleAlertas ? (
              <Alertas handlePressButtons={handlePressButtons} socket={socket} navigation={navigation}/>
            ): (null)}

          <Mapa handlePressButtons={handlePressButtons} socket={socket} verTipoAlertas={isVisibleTipoAlertas} setIsVisibleTipoAlertas={setIsVisibleTipoAlertas} navigation={navigation} /> 
        </View>
